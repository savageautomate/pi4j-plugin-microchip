 ...
 * @version $Id: $Id
 */
public abstract class MicrochipDigitalInputProviderBase extends DigitalInputProviderBase implements MicrochipDigitalInputProvider {
    ...
    /** {@inheritDoc} */
    @Override
    public abstract DigitalInput create(DigitalInputConfig config);
}
